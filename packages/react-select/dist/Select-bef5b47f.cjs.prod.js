...
var _ref$1 = {
  ...
  function ScrollCaptor() {
    ...
    _this.isTop = !1, _this.scrollTarget = void 0, _this.touchStart = void 0, _this.cancelScroll = function(event) {
      ...
      var _this$props = _this.props, onBottomArrive = _this$props.onBottomArrive, onTopArrive = _this$props.onTopArrive, _this$scrollTarget = _this.scrollTarget, scrollTop = _this$scrollTarget.scrollTop, scrollHeight = _this$scrollTarget.scrollHeight;
      scrollHeight - scrollTop === _this$scrollTarget.clientHeight ? (onBottomArrive && !_this.isBottom && onBottomArrive(event), 
      target.scrollTop = scrollHeight, _this.cancelScroll(event)) : 0 === scrollTop && (onTopArrive && !_this.isTop && onTopArrive(event), 
      target.scrollTop = 0, _this.cancelScroll(event));
    }, _this.getScrollTarget = function(ref) {
  ...
  return _inherits(ScrollCaptor, _Component), _createClass(ScrollCaptor, [ {
    ...
    key: "startListening",
    value: function(el) {
      el && "function" == typeof el.addEventListener && el.addEventListener("scroll", this.onScroll, !1);
    }
  }, {
    key: "stopListening",
    value: function(el) {
      "function" == typeof el.removeEventListener && el.removeEventListener("scroll", this.onScroll, !1);
    }
  }, {
    key: "render",
    value: function() {
